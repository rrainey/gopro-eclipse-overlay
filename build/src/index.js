...
function findSecondIndexOf(str, target) {
...
GPMFExtract(buffer)
    ...
    goProTelemetry(extracted, {}, (telemetry) => {
        ...
        gpsStream.forEach((sample, i) => {
            ...
            output.push(`drawtext=fontfile=./DejaVu_Sans/DejaVuSans-Bold.ttf:expansion=none:text='${label}':` +
