...
export var OverlapState;
(function (OverlapState) {
    OverlapState["NO_OVERLAP"] = "NO_OVERLAP";
    OverlapState["OVERLAP"] = "OVERLAP";
    OverlapState["HIDDEN"] = "HIDDEN";
 ...
 */
export function computeCircleOverlap(r1, r2, d) {
    const PI = Math.PI;
    if (d >= r1 + r2) {
...
export function computeEclipseStatus(date, location) {
...
//# sourceMappingURL=computeEclipseStatus.js.map